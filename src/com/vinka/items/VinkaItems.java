...
public class VinkaItems {
	...
	public static ItemStack IRON_ORE() {
		return ItemModule.item("Cerussite", "?", Material.LIGHT_GRAY_DYE);
	}

	public static ItemStack GOLD_ORE() {
		return ItemModule.item("Limonite", "?", Material.DANDELION_YELLOW);
	}

	public static ItemStack DIAMOND_ORE() {
		return ItemModule.item("Azurite", "?", Material.LIGHT_BLUE_DYE);
	}
